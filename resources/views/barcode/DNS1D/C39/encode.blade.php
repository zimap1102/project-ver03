	...
	<section class="section-compact">
		<div class="container">
			...
			<div class="form-main-container">
				<form class="checkout-form" method="post" action="{{asset('barcode/DNS1D/C39/encode')}}">
				{{ csrf_field() }}  
					<div class="row">
								...
								<div class="col-md-11">
									...
									<div align="center">
										@if(!empty(session('value_en')))
											{!! DNS1D::getBarcodeHTML(session('value_en'),'C39') !!}@endif
										
										<p style="text-align: center;">{{session('value_en')}}</p>
									</div>
