	...
	<section class="section-banner">
		<div class="container">
			<ul class="breadcrumb">
                ...
                <li><a class="active">OCT TO DEC-HEX-BIN</a></li>
			</ul>
		</div>
	...
	<section class="section-compact">
		<div class="container">
			<header class="heading-3 page-heading">
				<h4>OCT TO DEC-HEX-BIN</h4>
			</header>
			
			<div class="form-main-container">
				<form class="checkout-form" method="post" action="{{asset('oct')}}">
				{{ csrf_field() }}  
					<div class="row">
					...
					<div class="col-sm-6 form-block">
							<div class="col-md-12"> 
								...
								<label>Octal</label>
								<input type="text" name="oct"value="@if(!empty(session('oct'))) {{session('oct')}} @endif" class="form-control" placeholder="(base 8)">
