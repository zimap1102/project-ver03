	...
	<section class="section-compact">
		<div class="container">
			...
			<div class="form-main-container">
				<form class="checkout-form" method="post" action="{{asset('url/encode')}}">
				{{ csrf_field() }}  
					<div class="row">
					...
					@endif
						<div class="col-sm-6 form-block">
							...
							<div class="col-md-12"> 
								...
								<textarea name="string_decode" type="array"  id="" cols="30" rows="10" class="form-control " style="resize: none;background-color:#f5f5f5;">@if(!empty(session('value_decode'))){{session('value_decode')}} @endif</textarea>
